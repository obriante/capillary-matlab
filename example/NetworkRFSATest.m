...
% [deviceRandomSlots, txFrames, frameStatus, successDevices, transitionFrames]=ReservedFramedSlottedALOHA(network, nSlots)
[deviceRandomSlots, txFrames, frameStatus, successDevices, transitionFrames, network]=network.RFSALOHA(nSlots, 0)
packets2Transmit=network.packets2Transmit()

% coordinatorEnergy=network.parameters.EnergyEximationCoordinator(nSlots, txFrames)
% nodeEnergy=network.parameters.EnergyEximationEndDevice(nSlots, deviceRandomSlots)
